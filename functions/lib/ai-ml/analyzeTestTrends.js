...
exports.analyzeTestTrends = void 0;
...
exports.analyzeTestTrends = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const sortedResults = [...historicalResults].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
        ...
        // Get AI insights
        const insights = await generateAIInsights(testCode, sortedResults, trend, stats, patientInfo);
...
function generatePrediction(results, trend) {
...
async function generateAIInsights(testCode, results, trend, stats, patientInfo) {
...
//# sourceMappingURL=analyzeTestTrends.js.map