...
exports.sendSuperAdminCredentials = exports.deactivateUser = exports.updateUserRole = exports.createUserAccount = void 0;
...
exports.sendSuperAdminCredentials = functions.https.onCall(async (data, context) => {
    ...
    `;
        // Send email
        await emailService_1.emailService.send(email, 'Your LabFlow Super Admin Credentials', emailHtml);
