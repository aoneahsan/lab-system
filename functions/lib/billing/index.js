...
exports.reconcilePayments = exports.submitInsuranceClaim = exports.processPayment = exports.createInvoice = void 0;
...
exports.submitInsuranceClaim = functions.https.onCall(async (data, context) => {
    if (!context.auth || !['ADMIN', 'BILLING_STAFF'].includes(context.auth.token.role)) {
        throw new functions.https.HttpsError('permission-denied', 'Unauthorized');
    }
...
exports.reconcilePayments = functions.pubsub
...
async function simulateClaimSubmission(claimId) {
...
async function verifyPaymentWithProcessor(payment) {
