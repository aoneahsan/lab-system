...
exports.generateQualityControlReport = exports.generatePatientReport = exports.generateMonthlyReport = void 0;
...
exports.generateMonthlyReport = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const pdfBuffer = await (0, pdfGeneratorService_1.generatePDF)({
            ...
            data: {
                tenantId,
                period: (0, date_fns_1.format)(startDate, 'MMMM yyyy'),
                ...reportData,
...
exports.generatePatientReport = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
...
exports.generateQualityControlReport = functions.https.onCall(async (data, context) => {
...
async function gatherMonthlyReportData(tenantId, startDate, endDate) {
    // Get test statistics
...
function calculateQCStatistics(qcData) {
    ...
    qcData.forEach(result => {
        Object.entries(result.values || {}).forEach(([param, value]) => {
            ...
            parameterStats[param].values.push(value);
        });
    });
...
function generateLeveyJenningsData(qcData) {
