      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
            ...
            <span className={`font-medium ${biometricStatus?.isAvailable ? 'text-success-600' : 'text-danger-600'}`}>
          ...
          <div className="flex justify-between">
            ...
            <span className={`font-medium ${biometricStatus?.isEnrolled ? 'text-success-600' : 'text-danger-600'}`}>
