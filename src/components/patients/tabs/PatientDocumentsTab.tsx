    ...
    <>
      ...
      {filteredDocuments.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 dark:bg-gray-900 rounded-lg">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Upload documents like lab reports, prescriptions, and insurance cards.
          </p>
          <div className="mt-6">
            <button
              className="btn btn-primary"
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <div className="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" onClick={() => setShowUploadDialog(false)} />
          ...
          <div className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
            ...
            <DocumentUpload
              ...
              onUploadComplete={() => {
                ...
                queryClient.invalidateQueries({ queryKey: ['patient', currentTenant?.id, patient.id] });
              }}
