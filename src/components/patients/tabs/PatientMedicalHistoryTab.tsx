...
export const PatientMedicalHistoryTab = ({ patient }: PatientMedicalHistoryTabProps) => {
  return (
    <div className="space-y-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 dark:text-white">{medication.prescribedBy || 'Unknown'}</p>
                      </div>
                    </div>
      ...
      {/* Past Medications */}
      {patient.medications.filter(med => med.endDate && new Date(med.endDate) < new Date()).length > 0 && (
        <div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      {format(medication.startDate, 'MMM dd, yyyy')} - {medication.endDate && format(medication.endDate, 'MMM dd, yyyy')}
                    </p>
                  </div>
                </div>
              </div>
