						...
						<Controller
							...
							render={({ field }) => (
								<DatePicker
									...
									className={`input ${
										errors.dateOfBirth ? 'border-danger-500' : ''
									}`}
									maxDate={new Date()}
								/>
							)}
				...
				<div className='space-y-4 mt-4'>
					...
					<div>
						...
						<input
							...
							type='text'
							className={`input ${
								errors.address?.line1 ? 'border-danger-500' : ''
							}`}
					...
					<div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
						<div>
							...
							<input
								...
								type='text'
								className={`input ${
									errors.address?.city ? 'border-danger-500' : ''
								}`}
						...
						<div>
							...
							<input
								...
								type='text'
								className={`input ${
									errors.address?.state ? 'border-danger-500' : ''
								}`}
						...
						<div>
							...
							<input
								...
								type='text'
								className={`input ${
									errors.address?.country ? 'border-danger-500' : ''
								}`}
						...
						<div>
							...
							<input
								...
								type='text'
								className={`input ${
									errors.address?.postalCode ? 'border-danger-500' : ''
								}`}
