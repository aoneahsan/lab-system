...
export const qcService = {
  ...
  async createQCRun(tenantId: string, userId: string, data: QCRunFormData): Promise<string> {
    const now = serverTimestamp() as Timestamp;
  ...
  async updateQCStatistics(tenantId: string, userId: string, materialId: string): Promise<void> {
